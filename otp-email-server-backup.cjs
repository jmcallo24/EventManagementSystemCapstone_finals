const ex// Gmail SMTP configuration using your NEW credentials
const transporter = nodemailer.createTransporter({
  service: 'gmail',
  auth: {
    user: 'callojohnmichael@gmail.com',
    pass: 'rceq dyaw drvx unyh'  // Your NEW Gmail app password
  }
});require('express');
...
const transporter = nodemailer.createTransport({
  service: 'gmail',
  auth: {
    user: 'sosareymondivane@gmail.com',
    pass: 'yvrk obpp xdgo jmwi'  // Your Gmail app password
  }
});
...
app.post('/send-otp', async (req, res) => {
  try {
    ...
    const mailOptions = {
      from: 'sosareymondivane@gmail.com',
      to: email,
